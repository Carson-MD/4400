/******************************************************************************
University of Windsor - Principles of Programming Languages (COMP 4400)
...
* Purpose: To list the positive matches (PM) and negative matches (NM) based on
*          a given drug & gene with RsN Allele
...
* Purpose: To list the positive matches (PM) and negative matches (NM) based on
*          a given drug & gene with Star Notation Allele
* Use with: Star Notation for Allele's (Not Unique Across All Genes)
* Sample Input Output:
* Input: list_effects(warfarin,'CYP2C9', '*1/*2', PM, NM).
* Output:
* NM = [(15590749,concentration),(12172336,concentration),(28296334,concentration),
*       (20531370,concentration),(12012142,concentration)]
* PM = []
*/
...
* Purpose: To count the list of positive matches (PM) and negative matches (NM)
*          based on a given drug & gene with RsN Allele
* Use with: RS Numbers (Unique Across All Genes)
* Sample Input Output:
...
* Purpose: To count the list of positive matches (PM) and negative matches (NM)
*          based on a given drug & gene with Star Notation Allele
* Use with: Star Notation 'for' Allele's (Not Unique Across All Genes)
* Sample Input Output:
...
* Purpose: To recommend certain medication based on the positive and negative
*          effects ratio for a specific gene with RsN Allele
* Use with: RS Numbers (Unique Across All Genes)
* Sample Input Output:
...
* Purpose: To recommend certain medication based on the positive 'and' negative
*          effects ratio 'for' a specific gene with Star Notation Allele
* Use with: Star Notation for Allele's (Not Unique Across All Genes)
* Sample Input Output:
...
/*
* Functor: list_condition
* Purpose: To show the conditions associated with a certain drug and a specific
*          gene with Star Notation or RsN Allele
* Use with: Star Notation or RsN for Allele's
* Sample Input Output:
* Input: list_condition(venlafaxine, 'CYP2D9', '*3', Condition).
* Output: Condition = depression
*/
list_condition(Drug, Gene, Allele, Condition):-
  association(Gene, Allele, Drug, _, _, _, Condition).
...
* Purpose: To calculate the appropriate drug does based on gene 'and' clearance
*          rate
* Use with: Star Notation for Allele's (Not Unique Across All Genes)
* Sample Input Output:
