...
association('CYP2C19', '*1/*1', amitriptyline, 15590749, -, 'concentration', 'NA').

association('CYP2C19', '*1/*2', amitriptyline, 15205367, -, 'metabolism', 'NA').
association('CYP2C19', '*1/*1', amitriptyline, 15205367, +, 'metabolism', 'NA').

association('CYP2C19', '*2/*2', amitriptyline, 12172336, +, 'concentration', 'NA').
association('CYP2C19', '*1/*1', amitriptyline, 12172336, -, 'concentration', 'NA').
...
association('CYP2C19', '*1/*1', amitriptyline, 28296334, -, 'concentration', 'NA').
...
association('CYP2C19', '*1/*1', amitriptyline, 20531370, +, 'metabolism', 'NA').
...
association('CYP2D9', '*1', amitriptyline, 27097346, +, 'clearance', 'NA').

association('CYP2D9', '*1/*1xN', amitriptyline, 22733128, +, 'discontinuation', 'NA').
association('CYP2D9', '*2/*2xN', amitriptyline, 22733128, +, 'discontinuation', 'NA').

association('CYP2D9', '*2', amitriptyline, 16044105, -, 'metabolism', 'NA').
association('CYP2D9', '*1/*1', amitriptyline, 16044105, -, 'metabolism', 'NA').
...
association('CYP2C19', '*1/*1', amitriptyline, 20531370, +, 'concentration', 'NA').
...
association('MDR1', rs2235040C, amitriptyline, 18215618, -, 'remission', 'depression').

association('CYP2D6', rs3892097TT, amitriptyline, 18070221, -, 'dose', 'NA').
association('CYP2D6', rs3892097CC, amitriptyline, 18070221, +, 'dose', 'NA').

association('MDR1', rs10248420G, amitriptyline, 18215618, +, 'remission', 'depression').
association('MDR1', rs10248420A, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('CYP2C19', rs4244285CC, amitriptyline, 20531370, -, 'plasma levels', 'NA').

association('CYP2D6', rs3892097TT, amitriptyline, 18070221, +, 'side effects', 'NA').
association('CYP2D6', rs3892097CC, amitriptyline, 18070221, -, 'side effects ', 'NA').
...
association('MDR1', rs11983225T, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('CYP2D9', '*2/*1xN', amitriptyline, 15590749, -, 'drug toxicity', 'NA').
...
association('MDR1', rs2032583AA, amitriptyline, 18215618, -, 'remission', 'depression').

association('MDR1', rs4148739C, amitriptyline, 18215618, +, 'remission', 'depression').
association('MDR1', rs4148739T, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('CYP2D9', '*1/*1', amitriptyline, 18070221, +, 'dose', 'NA').

association('MDR1', rs2235015A, amitriptyline, 18215618, +, 'remission', 'depression').
association('MDR1', rs2235015C, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('CYP2C19', '*1/*1', amitriptyline, 12172336, -, 'amitriptyline-nortriptyline ratio', 'NA').

association('MDR1', rs7787082A, amitriptyline, 18215618, +, 'remission', 'depression').
association('MDR1', rs7787082G, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs10280101A, amitriptyline, 18215618, -, 'remission', 'depression').

association('CYP2C19', rs4244285AA, amitriptyline, 16044105, +, 'amitriptyline-nortriptyline ratio', 'NA').
association('CYP2C19', rs4244285GG, amitriptyline, 16044105, -, 'amitriptyline-nortriptyline ratio', 'NA').

association('CYP2C19', '*1/*2', amitriptyline, 15205367, +, 'concentration', 'NA').
association('CYP2C19', '*1/*1', amitriptyline, 15205367, -, 'concentration', 'NA').

association('CYP2D9', '*4/*4', amitriptyline, 18070221, +, 'risk of side effects', 'NA').
association('CYP2D9', '*1/*1', amitriptyline, 18070221, -, 'risk of side effects', 'NA').
...
association('MDR1', rs4148740A, amitriptyline, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs4148740A, venlafaxine, 18215618, -, 'remission', 'depression').

association('FKBP5', rs1360780T, venlafaxine, 21449676, +, 'suicide risk', 'depression').
association('FKBP5', rs1360780C, venlafaxine, 21449676, -, 'suicide risk', 'depression').
...
association('HTR2A', rs7997012AA, venlafaxine, 22006095, -, 'response', 'NA').

association('MDR1', rs10280101C, venlafaxine, 18215618, +, 'remission', 'depression').
association('MDR1', rs10280101A, venlafaxine, 18215618, -, 'remission', 'depression').

association('CYP2D6', rs3892097CT, venlafaxine, 16642541, +, 'concentration', 'depression').
association('CYP2D6', rs3892097CC, venlafaxine, 16642541, -, 'concentration', 'depression').
...
association('MDR1', rs7787082G, venlafaxine, 18215618, -, 'remission', 'depression').

association('HTR1B', rs130058A, venlafaxine, 21449676, -, 'suicide risk', 'depression').
association('HTR1B', rs130058T, venlafaxine, 21449676, -, 'suicide risk', 'depression').
...
association('CYP2D9', '*1', venlafaxine, 26406933, +, 'clearance', 'NA').
...
association('CYP2D9', '*1/*1', venlafaxine, 17803873, +, 'dose', 'depression').
...
association('COMT', rs4680GG, venlafaxine, 22417933, -, 'response', 'anxiety').

association('MDR1', rs4148739C, venlafaxine, 18215618, +, 'remission', 'depression').
association('MDR1', rs4148739T, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs2032583AA, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs2032582C, venlafaxine, 21449676, -, 'suicide risk', 'depression').
...
association('MDR1', rs11983225T, venlafaxine, 18215618, -, 'remission', 'depression').

association('CYP2D9', '*4/*4', venlafaxine, 10774634, +, 'level', 'depression').
association('CYP2D9', '*1/*1', venlafaxine, 10774634, -, 'level', 'depression').

association('CYP2D6', 'NA', venlafaxine, 24858822, +, 'metabolism', 'elderly').

association('MDR1', rs10248420G, venlafaxine, 18215618, +, 'remission', 'depression').
association('MDR1', rs10248420A, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs2235040C, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('MDR1', rs2032583A, venlafaxine, 22641028, -, 'adverse effects', 'depression').

association('MDR1', rs12720067T, venlafaxine, 18215618, +, 'remission', 'depression').
association('MDR1', rs12720067C, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('CYP2D9', '*1/*1', venlafaxine, 18214456, +, 'metabolism', 'depression').
...
association('TPH2', rs1487278TT, venlafaxine, 18496129, -, 'response', 'depression').
...
association('CYP2D9', '*1/*1', venlafaxine, 25510856, -, 'concentration', 'healthy').
association('CYP2D9', '*1/*2', venlafaxine, 25510856, -, 'concentration', 'healthy').
...
association('MDR1', rs2235015C, venlafaxine, 18215618, -, 'remission', 'depression').
...
association('CYP2D9', '*1/*1', venlafaxine, 10877013, -, 'Cmax and AUC', 'healthy').

association('MDR1', rs2235040T, venlafaxine, 22641028, +, 'adverse effects', 'depression').
association('MDR1', rs2235040C, venlafaxine, 22641028, -, 'adverse effects', 'depression').
...
association('CYP2D9', '*1/*1', venlafaxine, 20174590, -, 'levels', 'OCD').
...
association('CYP2D9', '*1/*1', venlafaxine, 16044105, +, 'metabolism', 'NA').

association('CYP2D9', '*1xN', venlafaxine, 14652703, -, 'response', 'mood disorder').
association('CYP2D9', '*2xN', venlafaxine, 14652703, -, 'response', 'mood disorder').
...
association('FKBP5', rs4713916G, venlafaxine, 20709156, -, 'response', 'mood disorder').
...
association('CYP2D9', '*1/*1', venlafaxine, 16958828, +, 'side effects', 'depression').

association('MDR1', 'rs2235067T', venlafaxine, 18215618, +, 'remission', 'depression').
association('MDR1', 'rs2235067C', venlafaxine, 18215618, -, 'remission', 'depression').

association('CYP2D6', 'NA', venlafaxine, 24858822, -, 'metabolism', 'elderly').

association('FKBP5', rs3800373C, venlafaxine, 20709156, +, 'response', 'mood disorder').
association('FKBP5', rs3800373A, venlafaxine, 20709156, -, 'response', 'mood disorder').
